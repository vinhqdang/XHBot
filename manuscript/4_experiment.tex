...
The dataset simulates advanced bot camouflage, where malicious bot nodes strategically connect heavily to benign human users (heterophily). Massive random noise was injected into the base textual features to render bots and humans indistinguishable by profile characteristics alone, forcing the models to rely on structural representation learning. 
