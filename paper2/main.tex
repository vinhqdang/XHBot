...
why the canonical bot benchmarks cannot support this measurement at all, and report
where the $\eta = c\rho$ identity fails: it needs a degree correction, and remains
approximate under strong degree asymmetry.
