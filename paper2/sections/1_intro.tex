...
\begin{itemize}
    ...
    for a pruner of quality $\bar e_c$ (Theorem~\ref{thm:sgtr}). The qualitative
    version of this guarantee is known for graph
    attention~\cite{fountoulakis2023graph}; the contribution here is the rate. It
    converts an ablation delta into a statement about the operating regime, and makes
