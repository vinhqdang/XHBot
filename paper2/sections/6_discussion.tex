...
defence. That the tolerance saturates well short of $1$---and that the
achievable tie score is far weaker than a flawless one on the networks we
measure---means no realistic pruning rule is a permanent fix; the defence buys
operating range, and an adversary willing to spend ties can exceed it. Treating $\rho$ as a
