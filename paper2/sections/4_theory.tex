...
\subsection{Tri-channel aggregation is strictly more expressive}

\begin{theorem}[Strict expressivity separation]
\label{thm:thca}
...
structural reason a heterophilic channel is needed rather than merely helpful. The
argument is in the spirit of the multiset-injectivity analysis of
Xu et al.~\cite{xu2019powerful}, applied here to separate two aggregators rather
than to characterise maximal power.
